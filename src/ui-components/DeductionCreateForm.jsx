...
export default function DeductionCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setPercent(initialValues.percent);
    setFlat_amount(initialValues.flat_amount);
    setErrors({});
  };
  const validations = {
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new Deduction(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "DeductionCreateForm")}
      {...rest}
    >
      <TextField
        label="Reason"
